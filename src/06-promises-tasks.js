...
function chainPromises(array, action) {
  return array.reduce((acc, promise) => promise
    .then((result) => acc.then((acc2) => action(acc2, result)).catch(() => 0)).catch(() => acc));
}
